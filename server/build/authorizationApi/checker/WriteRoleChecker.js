...
var WriteRoleChecker = function (_BaseChecker) {
   _inherits(WriteRoleChecker, _BaseChecker);

   function WriteRoleChecker() {
      _classCallCheck(this, WriteRoleChecker);

      return _possibleConstructorReturn(this, (WriteRoleChecker.__proto__ || Object.getPrototypeOf(WriteRoleChecker)).apply(this, arguments));
   }

   _createClass(WriteRoleChecker, [{
      key: "_internalCheck",
   ...
   return WriteRoleChecker;
}(_BaseChecker3.default);

;

exports.default = WriteRoleChecker;