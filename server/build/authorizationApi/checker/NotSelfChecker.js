...
var NotSelfChecker = function (_BaseChecker) {
   _inherits(NotSelfChecker, _BaseChecker);

   function NotSelfChecker() {
      _classCallCheck(this, NotSelfChecker);

      return _possibleConstructorReturn(this, (NotSelfChecker.__proto__ || Object.getPrototypeOf(NotSelfChecker)).apply(this, arguments));
   }

   _createClass(NotSelfChecker, [{
      key: '_internalCheck',
   ...
   return NotSelfChecker;
}(_BaseChecker3.default);

;

exports.default = NotSelfChecker;