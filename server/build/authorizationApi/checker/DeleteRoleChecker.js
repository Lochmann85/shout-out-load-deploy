...
var DeleteRoleChecker = function (_BaseChecker) {
   _inherits(DeleteRoleChecker, _BaseChecker);

   function DeleteRoleChecker() {
      _classCallCheck(this, DeleteRoleChecker);

      return _possibleConstructorReturn(this, (DeleteRoleChecker.__proto__ || Object.getPrototypeOf(DeleteRoleChecker)).apply(this, arguments));
   }

   _createClass(DeleteRoleChecker, [{
      key: "_internalCheck",
   ...
   return DeleteRoleChecker;
}(_BaseChecker3.default);

;

exports.default = DeleteRoleChecker;