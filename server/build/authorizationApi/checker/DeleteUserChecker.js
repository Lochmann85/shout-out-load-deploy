...
var DeleteUserChecker = function (_BaseChecker) {
   _inherits(DeleteUserChecker, _BaseChecker);

   function DeleteUserChecker() {
      _classCallCheck(this, DeleteUserChecker);

      return _possibleConstructorReturn(this, (DeleteUserChecker.__proto__ || Object.getPrototypeOf(DeleteUserChecker)).apply(this, arguments));
   }

   _createClass(DeleteUserChecker, [{
      key: "_internalCheck",
   ...
   return DeleteUserChecker;
}(_BaseChecker3.default);

;

exports.default = DeleteUserChecker;