...
var ShoutChecker = function (_BaseChecker) {
   _inherits(ShoutChecker, _BaseChecker);

   function ShoutChecker() {
      _classCallCheck(this, ShoutChecker);

      return _possibleConstructorReturn(this, (ShoutChecker.__proto__ || Object.getPrototypeOf(ShoutChecker)).apply(this, arguments));
   }

   _createClass(ShoutChecker, [{
      key: "_internalCheck",
