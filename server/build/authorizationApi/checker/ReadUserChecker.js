...
var ReadUserChecker = function (_BaseChecker) {
   _inherits(ReadUserChecker, _BaseChecker);

   function ReadUserChecker() {
      _classCallCheck(this, ReadUserChecker);

      return _possibleConstructorReturn(this, (ReadUserChecker.__proto__ || Object.getPrototypeOf(ReadUserChecker)).apply(this, arguments));
   }

   _createClass(ReadUserChecker, [{
      key: "_internalCheck",
   ...
   return ReadUserChecker;
}(_BaseChecker3.default);

;

exports.default = ReadUserChecker;