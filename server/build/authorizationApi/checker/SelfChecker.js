...
var SelfChecker = function (_BaseChecker) {
   _inherits(SelfChecker, _BaseChecker);

   function SelfChecker() {
      _classCallCheck(this, SelfChecker);

      return _possibleConstructorReturn(this, (SelfChecker.__proto__ || Object.getPrototypeOf(SelfChecker)).apply(this, arguments));
   }

   _createClass(SelfChecker, [{
      key: '_internalCheck',
